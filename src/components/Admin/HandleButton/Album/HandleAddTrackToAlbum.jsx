...
function HandleAddTrackToAlbum({ albumId }) {
     ...
     const fetchTrackData = useCallback(async () => {
          try {
               const res = await axios.get(`http://localhost:8000/track/get_track?albumId=${albumId}&page=1`);
     ...
     const handleCheckboxChange = (trackId) => {
          ...
          setSelectedTracks(updatedSelectedTracks); console.log("🚀 ~ file: HandleAddTrackToAlbum.jsx:44 ~ handleCheckboxChange ~ updatedSelectedTracks:", updatedSelectedTracks);
     };
     ...
     const handleAdd = async (e) => {
          ...
          try {
               ...
               await axios.post(`http://localhost:8000/album/add_track_to_album/${albumId}`, {
                    trackId: selectedTracks
               });
               toast.success("Add Track to Album successfully", {
                    position: toast.POSITION.TOP_RIGHT,
               })

          } catch (error) {
               console.log("Handle Add track to Album", error);
...
HandleAddTrackToAlbum.propTypes = {
     albumId: PropTypes.string.isRequired,

};

export default HandleAddTrackToAlbum;